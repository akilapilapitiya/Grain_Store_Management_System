...
public class buyerEntity {
    ...
    public buyerEntity(String Buyer_ID, String Buyer_name, String Buyer_Password, String Buyer_Telephone) {
    ...
    public String toString() {
        return "buyerEntity{" + "Buyer_ID=" + Buyer_ID + ", Buyer_name=" + Buyer_name + ", Buyer_Password=" + Buyer_Password
                + ", Buyer_Telephone=" + Buyer_Telephone + "}";
    }
